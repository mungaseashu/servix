        ...
        >
          {services.map((service, index) => (
            <motion.div
              ...
              className={`group relative glass-card rounded-3xl p-6 cursor-pointer transition-all duration-300 hover:shadow-2xl ${
                service.featured ? "lg:row-span-1" : ""
              }`}
            >
              {/* Featured Badge */}
              {service.featured && (
                <div className="absolute top-4 right-4 px-2 py-1 rounded-full bg-accent/10 text-accent text-xs font-medium flex items-center gap-1">
